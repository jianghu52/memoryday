...
?>
<iframe src="http://cakephp2012.sinaapp.com/start.php" width="830" height="60" style="overflow:hidden; border:none;">
	<p>For updates and important announcements, visit http://cakefest.org</p>
</iframe>
<h1>CakePHP4SAE 2.1.1 移植版 By <a href='http://weio.com/anuan'>@文峰186</a></h1>
<h2>修改内容:</h2>
<span class="notice success">1.将Cache引擎改为Memcache</span>
<span class="notice success">2.使用sae_debug代替了基于文件系统的LOG</span>
